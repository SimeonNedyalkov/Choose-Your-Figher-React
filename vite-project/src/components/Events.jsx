                ...
                {events.map((event, index) => {
                    ...
                    return (
                        <animated.div
                            ...
                            style={hoverProps}
                            onMouseEnter={() => hoverApi.start({ transform: 'scale(1.05)', boxShadow: '0 8px 16px rgba(0,0,0,0.2)' })}
                            onMouseLeave={() => hoverApi.start({ transform: 'scale(1)', boxShadow: '0 4px 8px rgba(0,0,0,0.2)' })}
                        >
